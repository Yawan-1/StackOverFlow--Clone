            ...
            $('.likeForm').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            let likes = $(`#id_likes${thisElement.attr('data-pk')}`).find('div').html()
                            if (response.action == 'undislike_and_like') {
                                ...
                                $(`#id_likes${thisElement.attr('data-pk')}`).html(`<button name='submit' type='submit' value="like"><i  class="fas active fa-sort-up fa-4x"></i></button><div class="flex--item d-flex fd-column ai-center color-black fs-title">${likes}</div>`)

                            } else if (response.action == 'unlike') {
                                likes -= 1
                                $(`#id_likes${thisElement.attr('data-pk')}`).html(`<button name='submit' type='submit' value="like"><i  class="fas inactive fa-sort-up fa-4x"></i></button><div class="flex--item d-flex fd-column ai-center color-black fs-title">${likes}</div>`)
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.action == 'unlike_and_dislike') {
                            ...
                            $(`#id_likes${thisElement.attr('data-pk')}`).html(`<button name='submit' type='submit' value="dislike"><i  class="fas inactive fa-sort-up fa-4x"></i></button><div class="flex--item d-flex fd-column ai-center color-black fs-title">${likes}</div>`)
            ...
            $('.ansLikeForm').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            let ansLikes = $(`#id_Ans_UpVote${thatElement.attr('data-pk')}`).find('div').html()
                            // alert(ansLikes)
                            if (response.action == 'unDownVoteAndLike') {
                                ...
                                $(`#id_Ans_UpVote${thatElement.attr('data-pk')}`).html(`<button name='submit' type='submit' value="like"><i  class="fas active fa-sort-up fa-4x"></i></button><div class="flex--item d-flex fd-column ai-center color-black fs-title">${ansLikes}</div>`)

                            } else if (response.action == 'unlikeAnswer') {
                                ansLikes -= 1
                                $(`#id_Ans_UpVote${thatElement.attr('data-pk')}`).html(`<button name='submit' type='submit' value="voteAns"><i class="fas inactive fa-sort-up fa-4x"></i></button><div class="flex--item d-flex fd-column ai-center color-black fs-title">${ansLikes}</div>`)
                    ...
                    <button class="p8 s-btn d-flex flex__center fc-dark js-dismiss" tabindex="0" role="button" aria-label="Dismiss">
                        <svg class="m0 svg-icon iconClearSm" width="14" height="14" viewBox="0 0 14 14">
                            <path d="M12 3.41 10.59 2 7 5.59 3.41 2 2 3.41 5.59 7 2 10.59 3.41 12 7 8.41 10.59 12 12 10.59 8.41 7 12 3.41Z"></path>
                                ...
                                ansLikes ++
                                $(`#id_Ans_UpVote${thatElement.attr('data-pk')}`).html(`<button name='submit' type='submit' value="voteAns"><i  class="fas active fa-sort-up fa-4x"></i></button><div class="flex--item d-flex fd-column ai-center color-black fs-title">${ansLikes}</div>`)
                            }
                        }
                    })
                })
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.action == 'unUpvoteAndDownVote') {
                            ...
                            $(`#id_Ans_UpVote${thatElement.attr('data-pk')}`).html(`<button name='submit' type='submit' value="downVoteAns"><i  class="fas inactive fa-sort-up fa-4x"></i></button><div class="flex--item d-flex fd-column ai-center color-black fs-title">${ansLikes}</div>`)
